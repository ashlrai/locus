...
#
# === v0.5.0 (this formula version) ===
# 1. Tag:  git tag -a v0.5.0 -m "Locus v0.5.0" && git push origin v0.5.0
...
#
# === v0.4.0 reference digests (published 2026-08-16) ===
# Source archive (GitHub tag tarball):
#   https://github.com/ashlrai/locus/archive/refs/tags/v0.4.0.tar.gz
#   sha256: 046ccb3bf0d873793051ce2b170851bb44f3c6bf458178e2486cda960d04a358
# Release assets (gh release download v0.4.0 -R ashlrai/locus):
#   locus-aarch64-apple-darwin.tar.gz
#     sha256: 4f4b36d5cb73e857bfc90ee631021ac883113b2505f154a6b71c191710f4b514
#   locus-x86_64-apple-darwin.tar.gz
#     sha256: 75ca52de79260acb238f11b93b96d61cbfaf916fcd531d241184dbda53de9d9c
#   locus-x86_64-unknown-linux-gnu.tar.gz
#     sha256: d6fddad0c71f09f0dd47225d5ea82de8c5ef5798c27591311af52be9cc1c67d5
#
...
#
#   curl -sL "https://github.com/ashlrai/locus/releases/download/v0.5.0/locus-aarch64-apple-darwin.tar.gz" | shasum -a 256
#   curl -sL "https://github.com/ashlrai/locus/releases/download/v0.5.0/locus-x86_64-apple-darwin.tar.gz" | shasum -a 256
#   curl -sL "https://github.com/ashlrai/locus/releases/download/v0.5.0/locus-x86_64-unknown-linux-gnu.tar.gz" | shasum -a 256
#
# v0.4.0 asset digests (reference only):
#   aarch64-apple-darwin: 4f4b36d5cb73e857bfc90ee631021ac883113b2505f154a6b71c191710f4b514
#   x86_64-apple-darwin:  75ca52de79260acb238f11b93b96d61cbfaf916fcd531d241184dbda53de9d9c
#   x86_64-unknown-linux-gnu: d6fddad0c71f09f0dd47225d5ea82de8c5ef5798c27591311af52be9cc1c67d5
#
